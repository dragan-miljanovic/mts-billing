...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('call_charges', function (Blueprint $table) {
            ...
            $table->string('charge_mode', 32)->nullable();
            $table->integer('sequence_total')->nullable();
            $table->string('imsi', 32)->nullable();
            $table->string('calling_msisdn', 32)->nullable();
            $table->string('clip_suppress_number', 32)->nullable();
            ...
            $table->string('traffic_type', 32)->nullable();
            ...
            $table->boolean('charge_free_action')->nullable();
            ...
            $table->bigInteger('account_difference')->nullable();
            $table->bigInteger('charge_amount')->nullable();
            $table->bigInteger('account_id')->nullable();
            $table->string('currency', 64)->nullable();
            $table->bigInteger('closing_balance')->nullable();
            $table->string('account_type', 32)->nullable();
            $table->string('crce_result_code', 32)->nullable();
